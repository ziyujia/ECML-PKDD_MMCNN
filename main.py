...
def main():
    ...
    for fold in range(k):
        ...
        train_label = np.concatenate(
            (label[:num_validation_samples * fold], label[num_validation_samples * (fold + 1):]),
            axis=0)
        # shuffle
        ...
        # Gauss
        data_aug_train_gauss, label_aug_train_gauss = GetData.gauss_data_augmentation(train_data, train_label, 0.005,
                                                                                      m=2)
